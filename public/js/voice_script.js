        // Scroll to top
        $("html, body").animate({ scrollLeft: (1600 - document.body.clientWidth)/2 }, "slow");

        $("html, body").animate({ scrollTop: 0 }, "slow");

        voice()
        document.getElementById("message").innerHTML =  `Voice controls are disabled!`
        setTimeout(function(){
            notification.close()
        }, 1600);
        ...
        async function voice(){
            ...
            },
            {
                ...
                template: '<div data-notify="container" class="alert_dark" style = "margin-bottom:10pc">' +
